export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx31c8ec65b7b41191",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "be3dea036376d19c34cd25e93d70c8e9",
  ...
  USERS: [
    {
      ...
      id: "osB2a5tXXcSEGGKS0argLErqxMhM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "TAA_4EyZS6As4fqDxU7tfFvoqKhKpeYQKFaL3iaGW_w",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
